...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if ( empty($_POST['user']) || empty($_POST['pass']) || empty($_POST['type']) || empty($_POST['amount'])) {
    ?>
...
include_once "paymentdone.php";
 }
else {
  ?>
  <h1 style="text-align:center">Failed!!! username and password incorrect</h1>
  <?php
}
}
}
